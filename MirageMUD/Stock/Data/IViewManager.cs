...
namespace Mirage.Stock.Data
{
    ...
    public interface IViewManager
    {
        ...
        string GetTitle(Living observer, Living target);
        ...
        /// <param name="target">the target mobile or player</param>
        /// <returns>title</returns>
        string GetShort(Living observer, Living target);
        ...
        /// <param name="target">the target mobile or player</param>
        /// <returns>title</returns>
        string GetLong(Living observer, Living target);
        ...
        /// <returns></returns>
        VisiblityType GetVisibility(Living observer, Living target);
    }
}
